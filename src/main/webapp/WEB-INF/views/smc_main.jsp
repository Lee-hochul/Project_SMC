...
<div class="nbar" style="background: linear-gradient(to right, #964aff, #27cdfd);">
   <div class="ddown">
	...
	<div class="ddown" style = "margin-right: 1.5%;">
		<button class="dbtn cate" onclick="location.href='<%=request.getContextPath()%>/l_category.do?cate_code=${ldto.getCate_code() }'">${ldto.getCate_name() }
