...
<div class="container" style="margin-left: 24%">
    ...
    <div class="col-md-10">
        ...
        <h3 class="entry-title" align="center"><span><font color="#3A4CA8" style="font-weight: bolder;">회원 정보수정</font></span> </h3>
        <hr style="border:solid 1px #3A4CA8;">
        <br><br>
        	<form action="<%=request.getContextPath() %>/member_edit_ok.do" method="post" name="signup" id="signup" class="form-horizontal">
        	<input type="hidden" value="${dto.getMember_no() }" name="member_no">
   			<input type="hidden" value="${dto.getMember_pwd() }" name="member_pwd">
        <div class="form-group" style="float: left">
          <label class="control-label col-sm-3" style="size: 15px">회원 ID <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="text" class="form-control" name="member_id" id="member_id" placeholder="아이디를 입력해 주세요." value="${dto.getMember_id() }" readonly> 
          </div>
             </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="password" class="form-control" name="member_pwd" id="password" placeholder="유추하기 쉬운 비밀번호는 삼가해주세요." value="" required="true">
           </div>   
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="password" class="form-control" name="member_pwd_conf" id="cpassword" placeholder="동일한 비밀번호를 입력해주세요." value="" required="true">
            </div>  
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <input type="text" class="form-control" name="member_name" id="member_name" placeholder="이름을 입력해주세요." value="${dto.getMember_name() }" readonly>
          </div>
        </div>
        <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="수정" class="btn_blue">&nbsp;&nbsp;<input name="Submit" type="reset" value="초기화" class="btn_orange">
          </div>
        </div>
      </form>
    </div>
