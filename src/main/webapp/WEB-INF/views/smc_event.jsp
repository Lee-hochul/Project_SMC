...
<select id="sort_list">
	...
	<option value="satisfy" style='background-color: rgb(42,203,255);'>만족도순 </option>
</select>
</div>
<br><br><br> --%>

<div id="Mid_Cate_List" align="center" style="margin-top: 5%;">
<c:if test="${!empty list }">
<c:forEach items="${list }" var="dto">
<div id="Cate_list">
<i class="${icon }" id="icon" style="color: #3d4ea2;"></i>
<%-- 썸네일 이미지 --%>
...
<%-- 수강시작날짜 : ${dto.getLec_startdate().substring(0,4) }/${dto.getLec_startdate().substring(5,7) }/${dto.getLec_startdate().substring(8,10) } <br> --%>
